...
import com.aliyun.odps.cupid.client.rpc.CupidRpcChannelProxyTest
import com.aliyun.odps.cupid.client.spark.client.CupidSparkClientRunner
import com.aliyun.odps.cupid.client.spark.service.SparkClientServiceImpl
...
class CupidSparkClientTest {
  ...
  def testRequestCupid {
    ...
    val cupidSparkClient: CupidSparkClientRunner = new CupidSparkClientRunner(cupidRpcChannelProxyTest)
    val result: String = cupidSparkClient.checkServiceReady("hello")
    System.out.println("ready")
    Assert.assertEquals(result, "ready")
  }
}
